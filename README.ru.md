...
- Менеджер кастомных шаблонов: создание, редактирование, клонирование, дублирование и удаление из UI
- Метаданные шаблона: иконка, акцентный цвет, имя отправителя, тема и HTML-тело письма
...
- Расширенная система анимаций UI: переходы страниц, анимации карточек/кнопок/инпутов, модалок и счётчиков
...
- Кастомная модалка шаблона с drag-and-drop импортом HTML и live-переключением Код/Превью
...
- Кастомный курсор с магнитным hover-эффектом, click-burst партиклами и trail-партиклами
- Система акцентного цвета с пресетами и расширенным кастомным пикером (HSV canvas + HEX/RGB), применяемая глобально
- Акцентные обои/фон, партиклы курсора, кастомные скроллбары, цвета выделения текста и сворачиваемые секции UI
